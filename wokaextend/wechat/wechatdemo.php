...
//修改粉丝的备注
UserManage::setRemark($openId, '新昵称');
//获取网络状态
...
//上传图片
$menuId = Media::upload('/var/www/baidu_jgylogo3.jpg', 'image');
...
//给粉丝列表的用户群发图文消息
$result = AdvancedBroadcast::sentNewsByOpenId($fansList['data']['openid'], $mediaId);