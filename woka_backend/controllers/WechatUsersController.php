...
use common\models\woka\wechat\user\WechatUsersSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * WecharUsersController implements the CRUD actions for WechatUsers model.
 */
class WechatUsersController extends Controller
{
    ...
    {
        $searchModel = new WechatUsersSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->wechat_user_id]);
        } else {
