...
+function ($) {
  ...
  $(function(){
    ...
    // 基础toggle处理
      //播放按钮事件
         $(document).on('click', '.home_list_play_status', function (e) {
             if($(this).hasClass('active'))
             {
                 //暂停播放
                 parent.sub_pause($(this).attr('musicid'));
                 $(this).removeClass('active');
                 $(this).parent().parent().removeClass('active');
             } else {
                 //播放
                 parent.sub_play($(this).attr('musicid'));
                 $('.home_list').removeClass('active');
                 $('.home_list_play_status').removeClass('active');
                 $(this).addClass('active');
                 $(this).parent().parent().addClass('active');
             }
         });
      //喜欢按钮事件
         $(document).on('click', '.home_list_like_status', function (e) {

             if ($(this).hasClass('active')) {              
                 parent.sub_addlikesong($(this).attr('musicid'), $(this).attr('songname'));
               
                 $(this).removeClass('active');
             } else {
                 parent.sub_dellikesong($(this).attr('musicid'));
                 $(this).addClass('active');
             }
         });
      //喜欢收藏事件
         $(document).on('click', '.home_list_favorite_status', function (e) {
             if ($(this).hasClass('active')) {
                 $(this).parent().parent().parent().children('.top').children('.home_list_favorite').addClass('hidden');
                 $(this).removeClass('active');
             } else {
                 $(this).parent().parent().parent().children('.top').children('.home_list_favorite').removeClass('hidden');
                 $(this).addClass('active');
             }
         });
